...
DEBUG = os.getenv('DJANGO_DEBUG', 'False').lower() in ('true', '1', 't', 'on')

ALLOWED_HOSTS = os.getenv('DJANGO_ALLOWED_HOSTS', " ").split(',')
USE_X_FORWARDED_HOST = os.getenv('DJANGO_USE_X_FORWARDED_HOST', 'False').lower() in ('true', '1', 't')
